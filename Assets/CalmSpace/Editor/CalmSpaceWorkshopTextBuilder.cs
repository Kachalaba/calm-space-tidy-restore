...
namespace CalmSpace.Editor
{
    ...
    internal static class CalmSpaceWorkshopTextBuilder
    {
        ...
        private static readonly WorkshopTextEntry[] Entries =
        {
            ...
            E("memory.summer-trail-stones", "Grandmother brought a stone back from every walk. A house should remember where its people have been.", "Бабуся приносила камінець із кожної прогулянки. Дім має пам'ятати, де бували його люди.", "Бабушка приносила камень с каждой прогулки. Дом должен помнить, где бывали его люди."),
            E("memory.fix-everything", "Grandfather kept every screw. Nothing is thrown away while it can still hold something together.", "Дідусь зберігав кожен гвинтик. Нічого не викидають, поки воно ще може щось тримати.", "Дедушка хранил каждый винтик. Ничего не выбрасывают, пока оно ещё может что-то держать."),
            E("memory.open-windows", "Every spring the first thing they did was open this window. The workshop had to breathe before the work began.", "Щовесни першою справою відчиняли це вікно. Майстерня мала подихати, перш ніж починалася робота.", "Каждую весну первым делом открывали это окно. Мастерской нужно было подышать, прежде чем начиналась работа."),
